			...
			<div class="col-sm-4 side">
						...
						<div class="col-sm-12 searchBox-inner">
							<div class="form-group has-feedback">
								<form class="search_user" action="" method="post">
									...
									<button class="search_btn" type="submit" name='search'><i class="fa fa-search"></i></button>
								</form>
							</div>
						</div>
					</div>
				...
				<div class='side-three' id="privacy">
					...
					<div class="box privacy">
						...
						<br>
						<p style="color: #03a9f4;font-family:Joti One;"><b style="font-family:Joti One;font-size:20px;">Data gives you answers to your questions<br> just when you need them.</b><br><br>t’s personal. That’s why we protect your data.</p>
				...
				<div class='side-three' id="chat-wallpaper">
					...
					<div class="cont1">
						<a href='chatpage.php?color=fff'>
							<div class="box1" onclick="document.getElementById('conversation').style.backgroundColor = '#fff';"></div>
						</a>

						<a href='chatpage.php?color=b3ffff'>
							<div class="box2" onclick="document.getElementById('conversation').style.backgroundColor = '#b3ffff';"></div>
						</a>
						<a href='chatpage.php?color=e0e0eb'>
							<div class="box3" onclick="document.getElementById('conversation').style.backgroundColor='#e0e0eb';"></div>
						</a>
					</div>
					<div class="cont2">
						<a href='chatpage.php?color=f2ccff'>
							<div class="box4" onclick="document.getElementById('conversation').style.backgroundColor='#f2ccff';"></div>
						</a>
						<a href='chatpage.php?color=f2f2f2'>
							<div class="box5" onclick="document.getElementById('conversation').style.backgroundColor='#f2f2f2';"></div>
						</a>
						<a href='chatpage.php?color=d6d6f5'>
							<div class="box6" onclick="document.getElementById('conversation').style.backgroundColor='#d6d6f5';"></div>
						</a>
					</div>
					<div class="cont3">
						<a href='chatpage.php?color=ffe6f9'>
							<div class="box7" onclick=" document.getElementById('conversation').style.backgroundColor='#ffe6f9';"></div>
						</a>
						<a href='chatpage.php?color=ffb3b3'>
							<div class="box8" onclick="document.getElementById('conversation').style.backgroundColor='#ffb3b3';"></div>
						</a>
						<a href='chatpage.php?color=98F5B1'>
							<div class="box9" onclick="document.getElementById('conversation').style.backgroundColor='#98F5B1';"></div>
						</a>
					</div>
					<div class="cont4">
						<a href='chatpage.php?color=799fcb'>
							<div class="box10" onclick=" document.getElementById('conversation').style.backgroundColor='#799fcb';"></div>
						</a>
						<a href='chatpage.php?color=ecddd0'>
							<div class="box11" onclick="document.getElementById('conversation').style.backgroundColor='#ecddd0';"></div>
						</a>
						<a href='chatpage.php?color=f9665e'>
							<div class="box12" onclick="document.getElementById('conversation').style.backgroundColor='#f9665e';"></div>
						</a>
					</div>
				</div>
